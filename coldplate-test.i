...
[../]
  ...
  #[./outlet_temp]
   ...
   # boundary ='outlet'
 # [../]
 #Add outlet_temp but failed, error message:
 #*** ERROR ***
#The requested regular material property thermal_conductivity is declared as an AD property. 
#Either retrieve it as an AD property with getADMaterialProperty or declare it as a regular property wtih declareProperty
